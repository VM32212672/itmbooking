...
from .models import Category, Location, Bus, Schedule, Booking,Drive
...
# class SaveDrive(forms.ModelForm):
#     name= forms.CharField(max_length="250")
#     license = forms.CharField(max_length="250")
#     date_created = forms.DateTimeField(default=timezone.now)
#     date_updated = forms.DateTimeField(auto_now=True)

#     class Meta:
#         model = Drive
#         fields = ('name','license','date_created','date_updated')
...
class SaveBooking(forms.ModelForm):
    ...
    class Meta:
        model = Booking
        fields = ('code','schedule','name','seats','drive')
